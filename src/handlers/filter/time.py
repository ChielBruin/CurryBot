...
class TimeFilter (MessageHandler):
    ...
    def create(cls, stage, data, arg):
        ...
        elif stage is 3 or stage is 4:
            return cls._create_step(stage, data, arg,
                'hour', 'day', 0, 24
            )
        elif stage is 5 or stage is 6:
            return cls._create_step(stage, data, arg,
                'day', 'weekday', 1, 32
            )
        elif stage is 7 or stage is 8:
            return cls._create_step(stage, data, arg,
                'weekday', 'week', 0, 7, opt_string='Monday is 0 and Sunday is 6'
            )
        elif stage is 9 or stage is 10:
            return cls._create_step(stage, data, arg,
                'week', 'month', 1, 53
            )
        ...
        elif stage is 15 or stage is 16:
        ...
        elif stage is 17 and isinstance(arg, MessageHandler):
            data[0].append(arg)
            return (17, data, AskChild())
        elif stage is 17 and isinstance(arg, NoChild):
